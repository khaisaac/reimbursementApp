...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex">
            ...
            <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900 relative overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col justify-center px-12 xl:px-20">
                    ...
                    <div class="mt-10 flex items-center gap-6">
                        <div class="text-center">
                            ...
                            <div class="text-xs text-indigo-300 mt-1">Cash Advance</div>
                        </div>
                        <div class="w-px h-10 bg-white/20"></div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-white">ALW</div>
                            <div class="text-xs text-indigo-300 mt-1">Allowance</div>
                        </div>
                        <div class="w-px h-10 bg-white/20"></div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-white">RMB</div>
                            <div class="text-xs text-indigo-300 mt-1">Reimbursement</div>
                        </div>
                    </div>
                </div>
            </div>
